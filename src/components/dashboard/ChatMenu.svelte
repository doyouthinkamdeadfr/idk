...
<div class="relative">
	<button
		onclick={toggle}
		class="flex h-6 w-6 items-center justify-center rounded text-text-muted opacity-0 transition-all group-hover:opacity-100 hover:bg-bg-primary hover:text-text-primary"
	>
	...
	{#if open}
		<div
			class="absolute top-full right-0 z-50 mt-1 w-44 rounded-xl border border-border-subtle bg-white py-1 shadow-lg"
		...
		>
			...
			<button
				...
				class="flex w-full items-center gap-2.5 px-3 py-2 text-xs text-red-500 transition-colors hover:bg-red-50"
			>
